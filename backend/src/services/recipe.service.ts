...
import type { RecipeSearchResult, RecipeByIngredientItem, RecipeDetail } from '../types/recipe.types';
...
export class RecipeService {
  /** Tìm kiếm chung theo từ khóa và/hoặc cuisine */
  async searchRecipes(
    query: string,
    cuisine: string,
    source?: string,
  ...
  /** Tìm kiếm theo danh sách nguyên liệu (chuỗi phân cách bằng dấu phẩy) */
